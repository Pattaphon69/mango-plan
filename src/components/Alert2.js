      ...
      return (
        <View style={styles.alert}>
          ...
          <View style={{ paddingTop: 20 }}>
            <Text style={[styles.alertText, styles.h5_bold, { color: colors.black_t }]}>{ message || "ส่งอนุมัติเรียบร้อยกลับสู่เมนุหลัก"} </Text>
          </View>
          <View style={[styles.rows, { paddingTop: 20, width: '100%' }]}>
            <Ripple
              ...
              rippleOpacity={0.87}
              rippleDuration={1000}
              style={[styles.button2, { backgroundColor:  colors.red, borderColor: colors.red, width: '100%', marginHorizontal: 0 }]}
              onPress={() => onConfirm()}
            >
